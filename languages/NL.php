...
define('fb_backend_options_updated',					'Opties voor de feedback module als ze zijn ge�pdated.');
...
define('fb_backend_success_update',						'Het commentaar [<strong>%05d</strong>] is ge�pdate.');
